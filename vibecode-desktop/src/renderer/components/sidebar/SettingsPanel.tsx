...
const PROVIDER_TYPES: { value: ProviderType; label: string; needsApiKey: boolean; defaultBaseUrl: string }[] = [
  ...
  { value: 'openrouter', label: 'OpenRouter', needsApiKey: true, defaultBaseUrl: 'https://openrouter.ai/api/v1' },
  { value: 'groq', label: 'Groq', needsApiKey: true, defaultBaseUrl: 'https://api.groq.com/openai/v1' },
  { value: 'deepseek', label: 'DeepSeek', needsApiKey: true, defaultBaseUrl: 'https://api.deepseek.com/v1' },
